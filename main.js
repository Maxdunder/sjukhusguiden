...
// ===== Debug-mode toggle =====
const DEBUG_MODE = true; // true = marker rör sig mycket per liten GPS-förändring
...
if ('geolocation' in navigator) {
    navigator.geolocation.watchPosition(
        (position) => {
            ...
            const SCALE = DEBUG_MODE ? 500 : 50; // debug-mode förstärker rörelse
...
if (window.DeviceOrientationEvent) {
    window.addEventListener('deviceorientation', (event) => {
        ...
        marker.rotation.z = alpha; // rotera platt triangel
    }, true);
} else {
