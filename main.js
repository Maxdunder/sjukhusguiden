...
const STEP_FACTOR = 0.01; // liten rörelse för test inomhus
const ALPHA = 0.3; // lågpassfilter accelerometer
...
if(window.DeviceOrientationEvent){
    window.addEventListener('deviceorientation', e=>{
        ...
        marker.rotation.z = alpha; // pilen roterar med telefonens riktning
    }, true);
}
...
if(window.DeviceMotionEvent){
    window.addEventListener('devicemotion', e=>{
        ...
        // Dämpning för att inte flyga iväg
        velocity.x *= 0.9;
        velocity.z *= 0.9;
