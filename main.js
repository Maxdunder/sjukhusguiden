...
const ALPHA = 0.1; // lågpassfilterfaktor för accelerometer

// Startkoordinat i verkligheten (nollpunkt i 3D-scenen)
...
if(window.DeviceMotionEvent){
    window.addEventListener('devicemotion',(event)=>{
        ...
        // Flytta markören
        marker.position.x += filteredAccel.x * STEP_FACTOR;
        marker.position.z += filteredAccel.z * STEP_FACTOR;
